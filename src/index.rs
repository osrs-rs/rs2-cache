...
fn from_path_correct_extension() -> crate::Result<()> {
    let index2 = Index::from_path(2, "./data/cache/main_file_cache.idx2")?;
    let index15 = Index::from_path(15, "./data/cache/main_file_cache.idx15")?;
    let index255 = Index::from_path(255, "./data/cache/main_file_cache.idx255")?;
...
fn from_path_incorrect_extension() {
    Index::from_path(2, "./data/cache/main_file_cache.idx1").unwrap();
}
