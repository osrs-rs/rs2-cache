...
///
/// This type is broadly used across osrscache for any operation which may produce a
/// [CacheError](enum.CacheError.html).
///
/// # Examples
///
/// A convenience function that bubbles an `osrscache::Result` to its caller:
///
/// ```
/// use osrscache::Cache;
/// use osrscache::codec;
...
/// fn item_def_data(cache: &Cache) -> osrscache::Result<Vec<u8>> {
///     let index_id = 2;
///     let archive_id = 10;
///
